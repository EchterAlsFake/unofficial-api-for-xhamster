...
<p align="center"><em>An asynchronous Python API wrapper and scraper for xhamster.com</em></p>

<div align="center">
    <a href="https://pepy.tech/project/xhamster_api"><img src="https://static.pepy.tech/badge/xhamster_api" alt="Downloads"></a> +
    <a href="https://pepy.tech/project/unofficial-api-for-xhamster"><img src="https://static.pepy.tech/badge/unofficial-api-for-xhamster" alt="Downloads"></a>
    ...
    <a href="https://echteralsfake.me/ci/unofficial-api-for-xhamster/badge.svg"><img src="https://echteralsfake.me/ci/unofficial-api-for-xhamster/badge.svg" alt="Sync API Tests"/></a>
    </div>
...
| Category | Details |
|---|---|
| **Video/Short Fetching** | Fetch videos or shorts with full metadata (title, views, quality, date, etc.) |
| **Video/Short Downloading** | HLS-based downloading with quality selection |
| **Channel & Creator Profiles** | Fetch channel/pornstar/creator profiles and list their videos and shorts |
| **Video Search** | Search videos with advanced filters (quality, sorting, category, VR, duration, production type, FPS) |
| **User Login** | Login support to access liked videos and account playlists |
...
### Have a look at the [Documentation](https://docs.echteralsfake.me/xhamster) for more details
